...
function music_search($word, $type)
{
    ...
    $post_data = array(
        ...
        'offset' => '0',
        'limit' => '20',
        'type' => $type,//1是单曲,10专辑,100歌手,1000歌单,1002用户
    );
...
#echo get_artist_album("166009", "5");//艺术家 获取个数
#echo get_album_info("3021064");
#echo get_playlist_info("22320356");
#echo get_music_lyric("29567020");
#echo get_mv_info();
#echo get_search("Jay",10);

echo $_GET['callback'] . "(" . get_search($_GET['search'],$_GET['limit']) . ")";
